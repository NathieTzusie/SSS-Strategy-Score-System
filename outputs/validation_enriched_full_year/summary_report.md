...
**生成时间：** 2026-05-14 14:09:25
**数据文件：** outputs/data_quality/enriched_trades_full_year.csv
...
- **orderflow_state：** unknown (179, 80%) / neutral (43, 19%) / bearish (1, 0%) / bullish (1, 0%)
- **macro_state：** flow_driven (144, 64%) / neutral (80, 36%)

### regime = **trend_down** (154 笔交易)

- **structure_state：** trend_down (154, 100%)
- **volatility_state：** low (74, 48%) / high (49, 32%) / medium (31, 20%)
- **orderflow_state：** unknown (151, 98%) / neutral (2, 1%) / bearish (1, 1%)
- **macro_state：** flow_driven (96, 62%) / neutral (58, 38%)

### regime = **trend_up** (138 笔交易)

- **structure_state：** trend_up (138, 100%)
- **volatility_state：** high (71, 51%) / medium (35, 25%) / low (32, 23%)
- **orderflow_state：** unknown (114, 83%) / neutral (20, 14%) / bullish (4, 3%)
- **macro_state：** flow_driven (107, 78%) / neutral (31, 22%)
